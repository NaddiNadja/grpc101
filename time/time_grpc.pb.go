...
type GetCurrentTimeClient interface {
	GetTime(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetTimeReply, error)
}
...
func (c *getCurrentTimeClient) GetTime(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetTimeReply, error) {
	out := new(GetTimeReply)
	err := c.cc.Invoke(ctx, "/getCurrentTime/getTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GetCurrentTimeServer interface {
	GetTime(context.Context, *emptypb.Empty) (*GetTimeReply, error)
...
func (UnimplementedGetCurrentTimeServer) GetTime(context.Context, *emptypb.Empty) (*GetTimeReply, error) {
...
func _GetCurrentTime_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/getCurrentTime/getTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GetCurrentTimeServer).GetTime(ctx, req.(*emptypb.Empty))
	}
